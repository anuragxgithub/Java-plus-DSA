//Note: In this merge sort algo when we are dividing the array and copying it to new array
//so this will take extra space. So this is not a good way to do merge sort look 🌟MergeSort_2.
