package SortingAlgos;//In-place means that the algorithm does not use extra space for manipulating the
...
//This on eis better approach than SortingAlgos.MergeSort_1 b/z here we are dividing the array through index and
