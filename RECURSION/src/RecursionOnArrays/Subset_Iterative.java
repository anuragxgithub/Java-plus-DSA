package RecursionOnArrays;//subset 2^n.
//Easy Peasy
//SEE NOTES ⭐⭐
    ...
    static List<List<Integer>> subset(int[] arr) {
        ...
        for(int num : arr) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                innerLists.add(num);  //num will be added in copied list
...
//According to GPT.
//The time complexity of the given RecursionOnArrays.Subset_Iterative algorithm is O(2^n) where n is the length of the input
